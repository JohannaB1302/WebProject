...
<body>
    <h1>Bienvenue sur <strong>Indé-Couvertes</strong> !</h1>
    <h2>Recherchez les jeux qui vous correspondent</h2>
    ...
    <nav id="selection_critère">
        <div class="option_critère">
            <h3>Vous pouvez sélectionner au moins un critère de recherche</h3>
            <ul>
